...
public final class OrderUtils {
    ...
    public static int calculateScore(Order order, long startTime) {
        startTime = Math.max(startTime, order.getOrderTime());
        long oneWayShippingDuration = (long) Math.ceil(order.getDistance() / DroneDeliveryConstants.DRONE_SPEED_PER_SECOND);
        long deliveryTime = startTime + oneWayShippingDuration;
